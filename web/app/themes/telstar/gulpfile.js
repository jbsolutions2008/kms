...
gulp.task( 'watch', function() {
    ...
    gulp.watch( [paths.dev + '/js/**/*.js', paths.dev + '/js/*.js', 'js/**/*.js', '!js/theme.js', '!js/theme.min.js'], ['scripts'] );
...
gulp.task(
    ...
    function(cb) {
        gulpSequence (
            //"clean-vendor-assets",  //causing issues, commenting out
            //"copy-assets",
            ["styles", "imagemin", "scripts"]
        )(cb);
    }
);
